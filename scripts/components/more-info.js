    ...
    <div class="container col-wrap">
      <div class="row more-info__row">
        ...
        <div class="col-12 col-md-9 col-lg-8 col-xl-8 col-xxl-9 pad-0 more-info__wrapper">
          <h2 class="more-info__title">${card.title}</h2>
          <p class="more-info__summary">${card.description}</p>
          
          <div class="more-info__user-container">
            <div class="more-info__user-container__data">
              <div class="more-info__user-container__data__avatar" style="background-image: url(${card.avatar})"></div>
              <div class="more-info__user-container__data__data">
                <p class="more-info__user-container__data__name">${card.name}</p>
          ...
          <div class="col-12 pad-0 more-info__image" style="background-image: url(${card.coverUrl})"></div>
